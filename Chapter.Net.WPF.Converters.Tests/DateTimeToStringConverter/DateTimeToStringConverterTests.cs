// -----------------------------------------------------------------------------------------------------------------
// <copyright file="DateTimeToStringConverterTests.cs" company="dwndland">
...
public class DateTimeToStringConverterTests : ValueConverterTester<DateTimeToStringConverter>
{
    [TestCase(13)]
    [TestCase("Anything")]
    [TestCase(null)]
